...
var _a = process.env, _b = _a.AWS_ENDPOINT, AWS_ENDPOINT = _b === void 0 ? '' : _b, _c = _a.AWS_ACCESS_KEY_ID, AWS_ACCESS_KEY_ID = _c === void 0 ? '' : _c, _d = _a.AWS_SECRET_ACCESS_KEY, AWS_SECRET_ACCESS_KEY = _d === void 0 ? '' : _d, _e = _a.SQUISS_BODY_FORMAT, SQUISS_BODY_FORMAT = _e === void 0 ? 'json' : _e, _f = _a.SQS_REGION, SQS_REGION = _f === void 0 ? '' : _f, _g = _a.QUEUE_URL, QUEUE_URL = _g === void 0 ? '' : _g, _h = _a.QUEUE_NAME, QUEUE_NAME = _h === void 0 ? '' : _h, _j = _a.MAX_IN_FLIGHT, MAX_IN_FLIGHT = _j === void 0 ? '100' : _j, _k = _a.BATCH_SIZE, BATCH_SIZE = _k === void 0 ? '10' : _k, _l = _a.POOL_INTERVAL_MS, POOL_INTERVAL_MS = _l === void 0 ? '0' : _l, _m = _a.DEBUG_SQUISS, DEBUG_SQUISS = _m === void 0 ? '' : _m;
var queueUrl = QUEUE_NAME;
var awsConfig = {
...
if (AWS_ENDPOINT !== '') {
    queueUrl = "".concat(QUEUE_URL, "/queue/").concat(QUEUE_NAME);
...
if (DEBUG_SQUISS)
    console.log('SquissOptions', SquissOptions);
...
poller.on('message', function (msg) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                req = msg.body;
                if (!!req.s3Request) return [3 /*break*/, 2];
                return [4 /*yield*/, (0, onMessage_1.onMessage)(msg)];
            case 1:
                _c.sent();
                return [3 /*break*/, 3];
            case 2:
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [3 /*break*/, 3];
                                case 1:
                                    jsonString = data.Body ? data.Body.toString('utf-8') : '';
                                    msg.body = {
